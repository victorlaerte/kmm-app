package com.victorlaerte.kmmapp.shared.cache.shared
...
import com.victorlaerte.kmmapp.shared.cache.AppDatabase
import com.victorlaerte.kmmapp.shared.cache.script.AppDatabaseQueries
import com.victorlaerte.kmmapp.shared.cache.script.Rocket
import com.victorlaerte.kmmapp.shared.cache.script.SelectAllLaunchesInfo
import kotlin.Any
...
private class AppDatabaseQueriesImpl(
  ...
  override fun <T : Any> selectAllLaunchesInfo(mapper: (
    ...
    name: String?,
    type: String?
  ) -> T): Query<T> = Query(675914837, selectAllLaunchesInfo, driver, "AppDatabase.sq",
  ...
  override fun insertLaunch(
    ...
    notifyQueries(-971378197, {database.appDatabaseQueries.selectAllLaunchesInfo})
  }
  ...
  override fun insertRocket(
    ...
    notifyQueries(-787213044, {database.appDatabaseQueries.selectRocketById +
        database.appDatabaseQueries.selectAllLaunchesInfo})
  }

  override fun removeAllLaunches() {
    driver.execute(-1575231873, """DELETE FROM Launch""", 0)
    notifyQueries(-1575231873, {database.appDatabaseQueries.selectAllLaunchesInfo})
  }

  override fun removeAllRockets() {
    driver.execute(393507201, """DELETE FROM Rocket""", 0)
    notifyQueries(393507201, {database.appDatabaseQueries.selectRocketById +
        database.appDatabaseQueries.selectAllLaunchesInfo})
  }
  ...
  private inner class SelectRocketByIdQuery<out T : Any>(
    ...
    override fun execute(): SqlCursor = driver.executeQuery(1447901569, """
    |SELECT * FROM Rocket
    |WHERE id = ?
    """.trimMargin(), 1) {
      bindString(1, id)
